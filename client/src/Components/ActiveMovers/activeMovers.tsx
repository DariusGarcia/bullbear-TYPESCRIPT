      ...
      <div className='w-full mb-12'>
        <div className=' '>
          ...
          <div className='-mx-6 mt-4 sm:-mx-0 px-6 lg:px-8'>
            <table className=' divide-y divide-grey3 '>
              <thead className='rounded-md bg-grey'>
                <tr>
                  <th
                    scope='col'
                    className='py-4 pl-6 pr-3 md:w-96 md:max-w-96 text-left text-sm text-white sm:pl-0'>
                    Ticker
                  </th>
              ...
              <tbody className='divide-y divide-grey3 bg-grey rounded-md '>
                {topMovers?.slice(0, 5)?.map((ticker) => (
                  <tr key={ticker.ticker} className=' hover:bg-grey2'>
                    <td className='flex flex-col whitespace-nowrap md:w-96 md:max-w-96 py-4 pl-6 pr-3 text-sm font-medium text-white sm:pl-0'>
